        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-forest-600 to-emerald-500 flex items-center justify-center shadow-lg shadow-forest-600/20">
            ...
            <p className="text-sm text-neutral-500 dark:text-neutral-400 max-w-xs leading-relaxed">
              Intelligent soil analysis and smart crop recommendations powered by AI. Grow better, harvest smarter.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-neutral-400 hover:text-forest-600 transition-colors">
